<p align="center">
  <a href="../../README.md">
    <img alt="SAA: Selective Auditory Attention" src="../../assets/saa-hero.svg" width="326">
  </a>
</p>

# Built-with-SAA badge
...
Hosted variant always fresh from `main`. 124 × 20 px, ~700 bytes -
vendor `built-with-saa.svg` if you want offline rendering or a pinned
revision.

## Trademark

None. The badge is Apache-2.0. The badge is **not** a quality-mark; it
is shorthand for "links to the SAA repo."
